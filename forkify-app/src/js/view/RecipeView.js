...
export const clearRecipe = () => {
    htmlElements.recipe.innerHTML = '';
};

const createIngree = ingrediant => `
    <li class="recipe__item">
       <svg class="recipe__icon">
           <use href="img/icons.svg#icon-check"></use>
       </svg>
       <div class="recipe__count">${formaCount(ingrediant.count)}</div>
...
export const renderRecipe = (recipe, isLike) => {
    const html = `
            ...
            <div class="recipe__ingredients">
                <ul class="recipe__ingredient-list">
                    ...
                    ${recipe.ingredients.map(el => createIngree(el)).join('')}
    ...
    htmlElements.recipe.insertAdjacentHTML('afterbegin', html);
};

export const updateServingIngre = recipe => {
    ...
    countElement.forEach((el, i) => {
        el.textContent = formaCount(recipe.ingredients[i].count);
    });
}
